...
**Playwright** – End-to-end browser automation / JavaScript (Node.js) – Test scripting / Chromium Browser – Test execution
...
```bash
git clone https://github.com/kaloianjeliazkov/Test-GAN.git
```
...
Playwright lifecycle hooks are used in order to manage setup and cleanup. The browser is launched once in **beforeAll**, closed in **afterAll**, and a fresh browser context and page are created for each test in **beforeEach** and cleaned up in **afterEach**.
